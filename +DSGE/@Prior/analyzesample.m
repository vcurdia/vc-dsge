function analyzesample(obj)

% analyzesample
%
% Analyzes a sample of the prior distribution
%
% See also:
...
fprintf('\n*** Analyzing DSGE Prior Sample\n')
obj.TimeElapsed.start('AnalyzeSample')
...
%% Finish up
obj.TimeElapsed.stop('AnalyzeSample')
